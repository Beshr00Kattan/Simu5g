...
class CbrReceiver : public omnetpp::cSimpleModule
{
    ...
    // Network-wide packet delay/loss observer support -- see the identical
    // note in CbrSender.h.
    static omnetpp::simsignal_t packetDelayReceivedSignal;
    static omnetpp::simsignal_t appPacketReceivedSignal;
